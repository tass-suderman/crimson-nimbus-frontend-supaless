...
VITE_REACT_APP_FETCH_BASE: The URL of the backend server.

VITE_REACT_APP_DISCORD_LOGIN_URL: The OAuth URL generated by Discord. Include identity scope and ensure it returns a token rather than a code. Redirect goes to (frontend server URL)/login
